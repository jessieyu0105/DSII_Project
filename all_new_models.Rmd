...
grid.arrange(ice_rf_1,ice_rf_2,ice_rf_3,ice_rf_4,ice_rf_5,ice_rf_6, nrow = 2)
```
...
ice_gbm_6 <- gbm.fit4 %>% 
  partial(pred.var = "population_density", 
          grid.resolution = 100,
          ice = TRUE) %>%
  autoplot(train = x1, alpha = .1,
           center = TRUE) +
...
grid.arrange(ice_gbm_1,ice_gbm_2,ice_gbm_3,ice_gbm_4,ice_gbm_5,ice_gbm_6, nrow = 2)
```
