...
# Final - Planned analyses 

since our response variable (life expectancy) is continuous  

10-fold cross validation (without repeating)  

also report the variable importance    
...
* maybe: PCA, Clusting to explore the pattern among the observations      

compare models via cross-validation RMSE, cross-validation R-squared? (around 80%, increase as the number of predictors increase)

compare test MSE for model validation (to see if results are accurate)

**Paper writing: begin from 5/2 or 5/7**
